...
public class MapsActivity extends FragmentActivity implements OnMapReadyCallback, GoogleMap.OnMapLongClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Button mapButtom=findViewById(R.id.map_button);
//        mapButtom.setOnClickListener(t-> startActivity(new Intent(this,)));
    }
...
/*@Override
    ...
    private void handleMapLongClick(LatLng latLng) {
        ...
        returnWithInfo(latLng, GEOFENCE_RADIUS);// return with location info
    ...
    private void setCurrentLocationCircle(){
        ...
        Branch branch = (Branch) getIntent().getSerializableExtra(BRANCH_CLASS);
